...
INSERT OR REPLACE INTO documents
    (doc_id, href, category, doc_type, human_code, title, human_title,
     pub_date, first_published_date, effective_date, status,
...
INSERT_TITLE_FTS = """
INSERT INTO title_fts (doc_id, human_code, title, human_title, headings)
VALUES (?, ?, ?, ?, ?)
"""

DELETE_TITLE_FTS_BY_DOC = """
INSERT INTO title_fts (title_fts, doc_id, human_code, title, human_title, headings)
  SELECT 'delete', doc_id, human_code, title, human_title, headings FROM title_fts WHERE doc_id = ?
"""
